...
class FragmentSaverImplTest {
    ...
    private final FragmentSaverImpl fragmentSaverImpl = new FragmentSaverImpl(tableWriter, fragmentOperationFactory.getFragmentMetaDataManager());
    ...
    void save() {
        ...
        initFreeSpace();
        int startPos = fragmentSaverImpl.save(NAME_TABLE, tabularData, freeSpaceManager);
