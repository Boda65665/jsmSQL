...
class TableDoubleWriterTest {
    ...
    void write() {
        ...
        Double numberRead = getDoubleFromFile();
        assertEquals(TEST_DATA, numberRead);
    }

    private double getDoubleFromFile() {
