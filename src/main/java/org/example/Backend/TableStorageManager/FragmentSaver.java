...
public class FragmentSaver {
    ...
    public FragmentSaver(TableWriter tableWriter, FragmentOperationFactory fragmentOperationFactory) {
        this.tableWriter = tableWriter;
        fragmentMetaDataManager = fragmentOperationFactory.getFragmentMetaDataManager();
    }

    public void save(String tableName, TabularData data, FreeSpaceManager freeSpaceManager) {
